...
globalkeys = gears.table.join(
    ...
    -- Menubar
    awful.key({ modkey }, "Print", function() awful.spawn.with_shell("scrot '%F_%H-%M-%S_$wx$h.png'") end,
              {description = "show the menubar", group = "launcher"}),
    awful.key({ modkey }, "r", function() awful.spawn.with_shell('~/.config/polybar/launch.sh') end,
              {description = "show the menubar", group = "launcher"}),
...
-- Autostart
awful.spawn.with_shell("nitrogen --random ~/nordic-wallpapers/wallpapers/ --set-zoom-fill")
awful.spawn.with_shell("picom -f")
awful.spawn.with_shell('/home/hackorum/.config/polybar/launch.sh')
awful.spawn.with_shell('/home/hackorum/.screenlayout/hp24.sh')
